...
// Đoạn code này dùng để hiện thị thông tin của các NFT (không thể bỏ đoạn này)
...
// Đoạn này là toàn bộ nội dung của NFT nên không thể bỏ.
...
const nftSlice = createSlice({
    ...
    reducers: {
        ...
        //     console.log('numberOFTOekn: ', numberOfOwnedTokens);
